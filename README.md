...
![Image](misc/lilygo-techo-copy.jpg)
...
![Image](misc/photo_2025-09-23_14-14-151.jpg)
...
Надо учитывать, что конструкции с контроллером [nRF52840](misc/NRF52840.pdf) более экономичные, чем с контроллером [ESP32](misc/mesh_17.jpg) с любыми буквами. Модемы в конструкциях должны быть на современных чипах SX1262, обязательно с интефейсом SPI, а не на устаревших SX1278 или на других, которые могут совсем не подходить к мештастику.

## САМОДЕЛЬНЫЙ {#самодельный}

Такой мештастик можно спаять самому, прикупив к нему модуль контроллера [ESP32](misc/mesh_17.jpg) или маломощный модуль контролера [nRF52840](misc/NRF52840.pdf), а также модуль LoRa [модема](https://docs.heltec.org/en/node/ht-ra62/index.html) с чипом SX1262 с интерфейсом I2C, [дисплей I2C OLED](misc/mesh_21.jpg), модуль [GPSa NEO-6M](misc/mesh_20.jpg) или NEO-8M, возможно и модулями всяких датчиков, например [BME280](miscc/datchik_bme280_01.jpg), кнопку и аккумуляторы с модулем зарядки.
...
![Image](misc/20250620_220013.jpg)
...
![Image](misc/20250620_230251.jpg)
...
![Image](misc/photo_2025-09-24_15-15-58.jpg)
...
Есть схемы самодельного мештастика на [ESP32](misc/MESHTASTIC.BMP) и на [nRF52840](misc/Schematic_Pro-Micro_Pinouts%202024-12-14.pdf). Монтаж желательно выполнять короткими проводами и НЕ располагать рядом с модемом никаких импульсных преобразователей, так как они могут уменьшать чувствительность приёмника.
